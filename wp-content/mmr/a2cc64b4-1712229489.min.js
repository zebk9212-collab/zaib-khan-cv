...
buttonStyles();$(this).ajaxComplete(function(){$('style[data-styles="aveo-theme-button-css"]').remove().detach();buttonStyles()})});(function($){$(document).ready(function($){var custom_styles="";function skillsStyles(){$('.skill-container').each(function(){var value=$(this).attr('data-value');if(typeof value!='undefined'){var id=$(this).attr('id'),$custom_style='#'+id+' .skill-percentage { width: '+value+'%; } ';custom_styles+=$custom_style}});$('head').append('<style data-styles="aveo-theme-skills-css" type="text/css">'+custom_styles+'</style>')}
skillsStyles();$(this).ajaxComplete(function(){$('style[data-styles="aveo-theme-skills-css"]').remove().detach();skillsStyles()})})})(jQuery);(function($){$(document).ready(function($){var mobile_mode_items="",tablet_mode_items="",items="";$('.testimonials').each(function(){var mobile_mode_items=$(this).attr('data-mobile-items'),tablet_mode_items=$(this).attr('data-tablet-items'),items=$(this).attr('data-items'),id=$(this).attr('id');$("#"+id+".testimonials.owl-carousel").owlCarousel({nav:!0,items:2,loop:!1,navText:!1,margin:10,responsive:{0:{items:mobile_mode_items,},768:{items:tablet_mode_items,},1200:{items:items,}}})})})})(jQuery);