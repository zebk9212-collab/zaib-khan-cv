(function($) {
    ...
    $(window)
        .on('load', function() { //Load
            $('body').append('<a id="lm_demo_panel_switcher" class="lm-demo-panel-switcher right"><i class="fa fa-gear"></i></a><div id="lm_demo_panel" class="lm-demo-panel right panel-color-red active"><div class="demo-panel-title">Main Color</div><div id="main_color" class="demo-panel-options"><a data-id="deep-purple"><div class="preview color-1">&nbsp;</div></a><a data-id="red"><div class="preview color-2">&nbsp;</div></a><a data-id="blue" class="current-main-color"><div class="preview color-3">&nbsp;</div></a><a data-id="deep-orange"><div class="preview color-4">&nbsp;</div></a><a data-id="green"><div class="preview color-5">&nbsp;</div></a><a data-id="light-blue"><div class="preview color-6">&nbsp;</div></a><a data-id="pink"><div class="preview color-7">&nbsp;</div></a><a data-id="purple"><div class="preview color-8">&nbsp;</div></a><a data-id="orange"><div class="preview color-9">&nbsp;</div></a><a data-id="amber"><div class="preview color-10">&nbsp;</div></a><a data-id="lime"><div class="preview color-11">&nbsp;</div></a><a data-id="teal"><div class="preview color-12">&nbsp;</div></a></div></div>');

        var demoPanel = $("#lm_demo_panel"),
        head = $('head'),
        demoPanelSwitcher = $("#lm_demo_panel_switcher");

        head.append('<link rel="stylesheet" href="//lmpixels.com/wp/aveo/wp-content/plugins/lmpixels-wp-demo/css/main-blue.css" type="text/css" data-id="custom">');
        ...
        $('#main_color').on("click", "a", function() {
            ...
            head.append('<link rel="stylesheet" href="//lmpixels.com/wp/aveo/wp-content/plugins/lmpixels-wp-demo/css/main-'+selector+'.css" type="text/css" data-id="custom">');
...
;
;(function($){$(document).on('ready',function(){$('.portfolio-content').each(function(){var portfolio_grid_container=$(this),portfolio_grid_container_id=$(this).attr('id'),portfolio_grid=$('#'+portfolio_grid_container_id+' .portfolio-grid'),load_more_button=$('#'+portfolio_grid_container_id+' .pf-load-more'),start_page_count=1;load_more_button.click(function(e){e.preventDefault();var button=$(this),pages=portfolio_grid.attr('data-pages-num'),categories=portfolio_grid_container.attr('data-categories'),categories_array=categories.split(','),data={'action':'loadmore','query':start_page_count,'page':start_page_count,'categories':categories_array,};$.ajax({url:ajaxurl,data:data,type:'POST',beforeSend:function(xhr){button.text(button.attr('data-load-text'))},success:function(data,html){if(data){button.text(button.attr('data-more-text'));start_page_count++;portfolio_grid.append(data);var $figure=portfolio_grid.find('figure:not(.shuffle-item)');$figure.imagesLoaded().always(function(){portfolio_grid.shuffle('appended',$figure)});if(start_page_count==pages){button.remove()}}else{button.remove()}}})})})})})(jQuery);/* Modernizr 2.8.3 (Custom Build) | MIT & BSD
 ...
 */
+function($){function getValue($el){return $el.is('[type="checkbox"]')?$el.prop('checked'):$el.is('[type="radio"]')?!!$('[name="'+$el.attr('name')+'"]:checked').length:$el.val()}
...
return instance}})(jQuery,window);/*! Magnific Popup - v1.1.0 - 2016-02-20
